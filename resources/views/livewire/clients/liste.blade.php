          ...
          <table class="table table-head-fixed">
            <thead>
              <tr>
                ...
                <th style="width:20%;" class="text-center">date et lieu de Naissance</th>
                
                <th style="width:20%;" class="text-center">nationalite</th>
                <th style="width:20%;" class="text-center">ville pays</th>
                <th style="width:20%;" class="text-center">email</th>
                <th style="width:20%;" class="text-center">CIN </th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{ $client->ville }} {{ $client->pays }}</td>
                <td>{{ $client->email }} </td>
